    ...
    <div>
      <div className="card-header text-end">
        ...
        onClick={toPdf}
          ...
          variant="warning"
        >
          <i className="bi bi-file-earmark-arrow-down-fill txt"></i> Download
          Details
        </Button>}
        </Pdf>
      </div>
      ...
      <Card>
        ...
        <Card.Body ref={ref}>
          ...
          <h4 className="txt">
            <i className="bi bi-people-fill"></i> : {total_enroll} students
          </h4>
          <Card.Footer className="d-lg-flex d-sm-grid App justify-content-between mt-3">
            ...
            <div>
              <Link to={`/enroll-course/${_id}`}>
                <Button
                  className=" fs-4 shadow-lg rounded btn-width txt trans"
                  variant="warning"
                >
                  <i className="bi bi-gift-fill txt"></i> Get Premium Access
                </Button>
              </Link>
            </div>
          </Card.Footer>
          <div className="text-center mt-2">
            <Link to={`/course-category/${category_id}`}>
              <button
                type="button"
                className="btn btn-outline-dark  shadow-sm rounded fs-5"
              >
                Similar Courses
              </button>
            </Link>
